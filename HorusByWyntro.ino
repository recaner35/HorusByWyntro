...
#define FIRMWARE_VERSION "1.0.341"
...
void startSetupMode() {
  ...
  // initWiFi() artık setup() içinde veya öncesinde çağrılıyor,
  // mDNS ve AP burada zaten yapılandırılmış olmalı.
  ...
  Serial.println("Setup Mode: ON (Captive Portal Active)");
}
